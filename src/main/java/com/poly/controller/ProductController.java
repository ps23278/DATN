...
import com.poly.entity.ProductCategory;
...
public class ProductController {
	...
	public String home(Model model,
			@RequestParam("kw") Optional<String> kw,  //keyword tìm kiếm
			@RequestParam("cid") Optional<String> cid, // Lọc id danh mục
			@RequestParam("bid") Optional<String> bid, //Lọc theo miền 
			@RequestParam("p") Optional<Integer> p) {  // trang
			if(cid.isPresent()) {
