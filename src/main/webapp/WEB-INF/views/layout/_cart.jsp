                            ...
                            <div id="header-cart" class="block block-cart">
                                <ul class="mini-products-list">
                                    <li ng-repeat="i in cart.items" class="item">
                                        <a class="product-image" href="#">
                                            <img style="width: 150px;height: 150px;display: block;" ng-src="/images/product/{{convertImage(i.images)}}"
                                                alt="{{i.name}}" title="" />
                                        </a>
                                ...
                                <div class="total">
                                    ...
                                    <div class="buttonSet text-center">
                                        <a href="/order/cart" class="btn btn-secondary btn--small">XEM MÓN GỌI</a>
                                        <a href="/order/checkout" class="btn btn-secondary btn--small">ĐẶT BÀN</a>
                                    </div>
                                </div>
                            </div>
                            <!--End Minicart Popup-->
