...
<div style="background-image: url(/images/banner/hero-bg.jpg)">
	<!--Search Form Drawer-->
	<div class="search">
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-3">
					...
					<p class="phone-no">
						<i class="anm anm-phone-s"></i> +84 6868686868
					</p>
				</div>
			...
			<div class="row align-items-center">
				...
				<div class="logo col-md-2 col-lg-2 d-none d-lg-block">
					<a style="text-decoration: none;" href="/"><h1
							style="font-size: 20px; font-weight: 600; color: rgb(39, 39, 39);">HƯƠNG
							QUÊ</h1> </a>
				...
				<div class="col-2 col-sm-3 col-md-3 col-lg-8">
					...
					<nav class="grid__item" id="AccessibleNav">
						...
						<ul id="siteNav" class="site-nav medium right hidearrow">
							...
							<li class="lvl1 parent megamenu"><a href="/product/list?kw=">Thực
									đơn <i class="anm anm-angle-down-l"></i>
							</a>
								<div class="megamenu style4">
									<ul class="grid grid--uniform mmWrapper">
										<li class="grid__item lvl-1 col-md-3 col-lg-3"><a
											href="#" class="site-nav lvl-1">Danh mục món ăn</a>
											<ul class="subLinks">
							...
							<li class="lvl1 parent megamenu"><a href="#">Tin tức <i
									class="anm anm-angle-down-l"></i>
							</a>
							<li class="lvl1"><a href="/"><b>ĐẶT BÀN</b> <i
									class="anm anm-angle-down-l"></i></a></li>
						</ul>
					</nav>
					<!--End Desktop Menu-->
	...
	<div class="mobile-nav-wrapper" role="navigation">
		...
		<ul id="MobileNav" class="mobile-nav">
			<li class="lvl1 parent megamenu"><a href="/home/index">trang
					chủ </a></li>
			<li class="lvl1 parent megamenu"><a href="#">Thực đơn <i
			...
			<li class="lvl1 parent megamenu"><a href="product-layout-1.html">Tin
					tức <i class="anm anm-plus-l"></i>
			</a>
				<ul>
					<li><a href="product-layout-1.html" class="site-nav"> </a></li>
				</ul></li>
			<li class="lvl1"><a href="#"><b>ĐẶT BÀN</b></a></li>
		</ul>
	</div>
	<!--End Mobile Menu-->
</div>