						...
						<form action="#">
							<div class="wishlist-table table-content table-responsive">
								<table class="table table-bordered">
									<thead>
										<tr>
											<th class="product-name text-center alt-font">Mã đặt bàn</th>
										...
										<c:forEach var="o" items="${orders }">
												<tr>
													...
													<td class="product-subtotal text-center"><a
														...
														<!-- 17/11/2023 -->
														<a style="margin-left: 20px;background-color: red"
														href="/order/delete/${o.order.id}"
														class="btn btn-danger text-white">Hủy đặt bàn</a>
														</td>
												</tr>
										</c:forEach>
									</tbody>
