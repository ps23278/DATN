			...
			<div class="collection-header">
				<div class="collection-hero">
					...
					<div class="collection-hero__title-wrapper">
						<h1 class="collection-hero__title page-width">THỰC ĐƠN</h1>
					</div>
				</div>
			</div>
										...
										<div class="col-6 col-sm-6 col-md-4 col-lg-4 item">
											...
											<div class="product-image">
												...
												<a href="/product/detail/${p.product.id}"> <!-- image -->
													<img style="width: 100%; height: 100%;" class="product primary blur-up lazyload"
												...
												<form class="variants add">
													<button ng-click="cart.add(${p.product.id})"
														class="btn btn-addto-cart" type="button">GỌI MÓN</button>
												</form>
